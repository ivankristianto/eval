 ...
 * @param judgeModelId - The model configuration ID for the judge
 * @param db - Database connection (optional, for storing decision)
...
export async function evaluateOutput(
  ...
  const fullPrompt = formatJudgePrompt(input, expectedOutput, suggestedOutput, judgePrompt);
