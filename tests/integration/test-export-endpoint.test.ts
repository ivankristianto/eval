...
describe('GET /api/templates/export', () => {
  ...
  it('should order templates by created_at descending', async () => {
    ...
    const template1 = insertTemplate('Template 1', 'Instruction 1', ['model-1'], 'exact_match');
    await new Promise((resolve) => setTimeout(resolve, 10)); // Small delay

    const template2 = insertTemplate('Template 2', 'Instruction 2', ['model-1'], 'exact_match');
